...
/* This was published by thetechwar.com */

var image="https://lh4.googleusercontent.com/-uSR-pXsjFQ8/U8fGMGd01XI/AAAAAAAAAFQ/zUCzm8WcArw/h120/oie_transparent.png";  //Image path should be given here
var no = 4; // No of images should fall
...
for (i = 0; i < no; ++ i) {  
	...
	document.write("<div id=\"dot"+ i +"\" style=\"overflow:hidden !important;POSITION: absolute; Z-INDEX: "+ (500+i) +"; VISIBILITY: visible; TOP: 15px;LEFT: 15px;\"><img src='"+image+"' border=\"0\"><\/div>");
}
